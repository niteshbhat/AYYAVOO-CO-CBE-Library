...
<option value="<?php echo htmlentities($result->CategoryName);?>"> <?php echo htmlentities($catname=$result->CategoryName);?></option>
<?php 
$status=1;
$sql1 = "SELECT * from  tblcategory where Status=:status";
$query1 = $dbh -> prepare($sql1);
...
<option value="<?php echo htmlentities($result->AuthorName);?>"> <?php echo htmlentities($athrname=$result->AuthorName);?></option>
<?php 
